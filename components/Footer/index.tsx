...
export default function HeaderComponent() {
  ...
  return (
    <>
      ...
      <H2>Copyright &copy; {1900 + new Date().getYear()} , todos os direitos reservados Educação Bento - Site Desenvolvido por <a href='https://luiss1569.github.io/luiss1569.github.io' target='_blank' rel="noreferrer">Luis Ricardo</a></H2>
    </>
  );
};
